...
public class StreamExample03 {
    ...
    public static <T extends Number> T sumElementsMoreGeneric(Collection<T> collection) {
    ...
    public static <T extends Number> double sumElements(List<T> nums) {
